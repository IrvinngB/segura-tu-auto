-- Add quotes table for customer quote requests that need agent approval
CREATE TABLE IF NOT EXISTS quotes (
    ...
    -- Quote specific data
    selected_coverages JSONB, -- Store the selected coverage types and their details
    driver_data JSONB, -- Store driver information used for calculation
    vehicle_data JSONB, -- Store vehicle information used for calculation
    risk_assessment JSONB, -- Store risk assessment data
    ...
    expires_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP + INTERVAL '30 days' -- Quotes expire after 30 days
);
...
-- Agents and admins can view all quotes
...
-- Agents and admins can manage quotes (approve/reject)
