-- Script para diagnosticar problemas con el procesamiento de cotizaciones
...
-- 13. Verificar clientes existentes
...
-- 14. Verificar vehículos existentes
SELECT 'Vehículos existentes:' as info;
SELECT 
    v.make,
    v.model,
    v.year,
