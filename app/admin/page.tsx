                ...
                <div className="mb-8 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Gestiona pólizas, usuarios y configuraciones del
                            sistema
                        </p>
                    </div>
                    <LogoutButton />
                    ...
                    <TabsContent value="policies" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Administra el estado y vencimiento de las
                                    pólizas de seguro
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <TabsContent value="users" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Administra usuarios, clientes y agentes del
                                    sistema
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <TabsContent value="vehicles" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Administra la información de vehículos
                                    registrados
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <TabsContent value="claims" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Administra y procesa las reclamaciones de
                                    seguros
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="text-center py-8 text-muted-foreground">
                                    Panel de gestión de reclamaciones -
                                    Próximamente
                                </div>
                            </CardContent>
                        </Card>
