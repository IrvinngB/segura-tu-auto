...
export default function AdminDashboard() {
  ...
  if (loading && activeUserTab === 'list' && users.length === 0) {
    return (
            ...
            <TabsContent value="vehicles" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Administra la información de vehículos registrados en el sistema
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <Card>
                      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Con Póliza Activa</CardTitle>
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    <p className="text-lg">Panel completo de gestión de vehículos</p>
                    <p className="text-sm mt-2">Próximamente - Funcionalidad en desarrollo</p>
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="claims" className="space-y-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    <p className="text-lg">Sistema completo de gestión de reclamaciones</p>
                    <p className="text-sm mt-2">Próximamente - Funcionalidad en desarrollo</p>
                  </div>
                </CardContent>
              </Card>
            ...
            <TabsContent value="settings" className="space-y-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    <p className="text-lg">Panel completo de configuración del sistema</p>
                    <p className="text-sm mt-2">Próximamente - Funcionalidad en desarrollo</p>
                  </div>
                </CardContent>
              </Card>
