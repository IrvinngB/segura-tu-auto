    ...
    const [testCases, setTestCases] = useState<TestCase[]>([
        {
            ...
            description:
                "Crear cotización con todos los campos completos y vehículo registrado",
            category: "validation",
            status: "pending",
        },
        {
            ...
            description:
                "Intentar crear cotización sin vehículo seleccionado o datos faltantes",
            category: "validation",
            status: "pending",
        },
        {
            ...
            description:
                "Ver cotización creada en la lista de cotizaciones del cliente",
            category: "ui",
            status: "pending",
        },
        {
            ...
            description:
                "Seleccionar diferentes planes (básico, completo, premium) y ver cambios en precio",
            category: "ui",
            status: "pending",
        },
        {
        ...
        },
        {
            ...
            description:
                "Crear póliza con método de pago configurado correctamente",
            category: "success",
            status: "pending",
        },
        {
            ...
            description:
                "Intentar crear póliza sin método de pago o con datos inválidos",
            category: "error",
            status: "pending",
        },
        {
            ...
            description:
                "Mostrar modal de confirmación después de crear cotización exitosamente",
            category: "success",
            status: "pending",
        },
        {
            ...
            description:
                "Mostrar modal de error cuando falla la creación de cotización",
            category: "error",
            status: "pending",
        },
        {
        ...
        },
        {
            ...
            description:
                "Prevenir creación de cotización si no hay vehículos registrados",
            category: "validation",
            status: "pending",
        },
        {
        ...
        <div className="container mx-auto py-8 px-4">
            <div className="mb-8">
                <h1 className="text-3xl font-bold mb-4">
                    Casos de Prueba - SeguraTuAuto
                </h1>
                <p className="text-muted-foreground mb-6">
                    Verificación de funcionalidades del sistema de cotizaciones
                    y pólizas
                </p>
            ...
            <Card className="mt-8">
                ...
                <CardContent className="space-y-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Registra un vehículo, ve a cotizaciones, completa
                            todos los campos y solicita la cotización.
                        </p>
                    </div>
                    <div>
                        <h4 className="font-semibold mb-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Intenta crear una cotización sin vehículo registrado
                            o sin completar campos requeridos.
                        </p>
                    </div>
                    <div>
                        <h4 className="font-semibold mb-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Crea una póliza para un vehículo e intenta crear
                            otra para el mismo vehículo.
                        </p>
                    </div>
                    <div>
                        <h4 className="font-semibold mb-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Prueba el flujo completo: configura métodos de pago,
                            crea cotización y procesa el pago.
                        </p>
                    </div>
                </CardContent>
            </Card>
