    ...
    const fetchAnalyticsData = async () => {
        try {
            ...
            const activePolicies =
                policiesResult.data?.filter((p) => p.status === "active")
                    .length || 0;
            const totalClaims = claimsResult.count || 0;
            const pendingClaims =
                claimsResult.data?.filter((c) =>
                    ["submitted", "under_review", "investigating"].includes(
                        c.status
                    )
                ).length || 0;
            ...
            const averageClaimAmount =
                claimsResult.data?.reduce(
                    (sum, c) => sum + (c.estimated_damage_cost || 0),
                    0
                ) / (totalClaims || 1) || 0;
            const approvedClaims =
                claimsResult.data?.filter((c) => c.status === "approved")
                    .length || 0;
    ...
    const generateChartData = (claims: any[], policies: any[]) => {
        ...
        setClaimsByType(
            Object.entries(claimTypeCount).map(([type, count]) => ({
                name:
                    claimTypeLabels[type as keyof typeof claimTypeLabels] ||
                    type,
                ...
                <div className="max-w-7xl mx-auto p-6">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Dashboard de métricas y estadísticas del negocio
                            </p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground">
                                    {analyticsData.activePolicies} activas
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">
                                    {analyticsData.totalClaims.toLocaleString()}
                                </div>
                                <p className="text-xs text-muted-foreground">
                                    {analyticsData.pendingClaims} pendientes
                                </p>
                            </CardContent>
                        </Card>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">
                                    $
                                    {analyticsData.averageClaimAmount.toLocaleString()}
                                </div>
                                <p className="text-xs text-muted-foreground">
                                    Promedio de daños estimados
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">
                                    {analyticsData.claimApprovalRate.toFixed(1)}
                                    %
                                </div>
                                <p className="text-xs text-muted-foreground">
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">
                                    {analyticsData.totalRevenue > 0
                                        ? (
                                              ((analyticsData.averageClaimAmount *
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Distribución de tipos de siniestros
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <ResponsiveContainer
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Estado actual de las reclamaciones
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <ResponsiveContainer
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Evolución de reclamaciones y montos
                                            por mes
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                        ...
                        <TabsContent value="risk" className="space-y-6">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Clasificación de clientes por nivel
                                            de riesgo
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Indicadores clave de gestión de
                                            riesgo
                                        </CardDescription>
                                    </CardHeader>
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Análisis de los principales factores que
                                        afectan el riesgo
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
