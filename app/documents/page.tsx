                    ...
                    ? {
                          ...
                          verificationResult: {
                              ...
                              extractedData: isValid
                                  ? generateMockExtractedData(doc.category)
                                  : undefined,
                              issues: isValid
                                  ? []
                                  : [
                ...
                <div className="max-w-6xl mx-auto p-6">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">
                            Sistema de subida y verificación automática de
                            documentos
                        </p>
                    </div>
                        ...
                        <div className="lg:col-span-2">
                            <Card className="mb-6">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Seleccione el tipo de documento y
                                        arrastre los archivos o haga clic para
                                        seleccionar
                                    </CardDescription>
                                </CardHeader>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    {doc
                                                                        ...
                                                                        <ul className="text-xs text-red-600 list-disc list-inside">
                                                                            {doc.verificationResult.issues.map(
                                                                                (
                                                                                    issue,
                                                                                    index
                                                                                ) => (
                        ...
                        <div>
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Documentos requeridos para diferentes
                                        procesos
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
