    ...
    const calculateRisk = () => {
        ...
        setTimeout(() => {
            const riskScore = calculateRiskScore(
                formData as RiskAssessmentData
            );
            setResult(riskScore);
            setLoading(false);
        }, 2000);
                ...
                <div className="max-w-6xl mx-auto p-6">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">
                            Motor propio de evaluación de riesgos para cálculo
                            de primas personalizadas
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Complete la información para calcular el
                                    riesgo
                                </CardDescription>
                            </CardHeader>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                <SelectItem value="urban-low">
                                                    Urbana - Bajo riesgo
                                                </SelectItem>
                                                <SelectItem value="urban-medium">
                                                    Urbana - Riesgo medio
                                                </SelectItem>
                                                <SelectItem value="urban-high">
                                                    Urbana - Alto riesgo
                                                </SelectItem>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Análisis de riesgo y prima calculada
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                {loading ? (
                                    ...
                                    <div className="text-center text-muted-foreground py-8">
                                        Complete el formulario para ver los
