...
export const metadata = {
    ...
    description:
        "Sistema integral para la gestión de pólizas y reclamaciones de seguros de autos",
    generator: "v0.app",
    icons: {
        icon: [
            {
        ...
        shortcut:
            'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%233b82f6"><path d="M12 1L3 5V11C3 16.55 6.84 21.74 12 23C17.16 21.74 21 16.55 21 11V5L12 1Z"/></svg>',
