...
const agentNavigation: NavigationItem[] = [
    ...
    { name: "Cotizaciones", href: "/quotes", icon: Calculator, description: "Gestión de cotizaciones" },
    { name: "Reclamaciones", href: "/claims", icon: AlertTriangle, description: "Gestión de reclamos" },
    { name: "Documentos", href: "/documents", icon: Upload, description: "Gestión de documentos" },
];

const customerNavigation: NavigationItem[] = [
    { name: "Dashboard", href: "/", icon: Home, description: "Panel principal" },
    { name: "Mis Pólizas", href: "/customer/policies", icon: FileText, description: "Mis pólizas de seguro" },
    { name: "Mis Cotizaciones", href: "/customer/quotes", icon: Calculator, description: "Mis cotizaciones de seguro" },
    { name: "Mis Reclamaciones", href: "/customer/claims", icon: AlertTriangle, description: "Mis reclamos" },
    { name: "Mis Vehículos", href: "/customer/vehicles", icon: Car, description: "Mis vehículos" },
    { name: "Nueva Cotización", href: "/customer/quote", icon: Calculator, description: "Solicitar cotización" },
    { name: "Pagos", href: "/customer/payments", icon: CreditCard, description: "Historial de pagos" },
    { name: "Comunicaciones", href: "/customer/communications", icon: MessageSquare, description: "Mensajes y notificaciones" },
];

const adjusterNavigation: NavigationItem[] = [
    { name: "Dashboard", href: "/", icon: Home, description: "Panel principal" },
    { name: "Reclamaciones", href: "/claims", icon: AlertTriangle, description: "Gestión de reclamos" },
    { name: "Evaluaciones", href: "/adjuster/assessments", icon: ClipboardList, description: "Evaluaciones de daños" },
    { name: "Mis Casos", href: "/adjuster/cases", icon: AlertTriangle, description: "Casos asignados" },
];
...
const SidebarContent = memo(function SidebarContent({ navigation, userProfile }: SidebarProps) {
    ...
    const getRoleDisplayName = (role: string) => {
        const roleNames = { admin: "Administrador", agent: "Agente", adjuster: "Ajustador", customer: "Cliente" };
...
export const CustomerSidebar = memo(function CustomerSidebar({ userProfile }: { userProfile: any }) {
    return <SidebarContent navigation={customerNavigation} userProfile={userProfile} />;
});

export const AdjusterSidebar = memo(function AdjusterSidebar({ userProfile }: { userProfile: any }) {
