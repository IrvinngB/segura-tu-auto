...
import { Search, Eye, Edit, FileText, Calendar, DollarSign, AlertTriangle, Clock } from "lucide-react"
                  ...
                  <TableRow key={claim.id}>
                    ...
                    {!customerId && (
                      <TableCell>
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">{claim.customer?.user?.email}</div>
                        </div>
                      </TableCell>
                    )}
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1 text-sm">
                        ...
                        <span>{format(new Date(claim.incident_date), "dd/MM/yyyy", { locale: es })}</span>
                      </div>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        <Button variant="ghost" size="sm" onClick={() => onViewClaim?.(claim)}>
                          <Eye className="h-4 w-4" />
                        </Button>
                        <Button variant="ghost" size="sm" onClick={() => onEditClaim?.(claim)}>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-2xl font-bold text-yellow-600">
                {filteredClaims.filter((c) => ["under_review", "investigating"].includes(c.status)).length}
              </div>
