...
import { Search, Eye, Edit, FileText, Calendar, DollarSign } from "lucide-react"
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{customerId ? "Pólizas del cliente" : "Gestión de todas las pólizas"}</CardDescription>
      </CardHeader>
      <CardContent>
        {/* Filters */}
                ...
                filteredPolicies.map((policy) => (
                  <TableRow key={policy.id}>
                    ...
                    {!customerId && (
                      <TableCell>
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">{policy.customer?.user?.email}</div>
                        </div>
                      </TableCell>
                    )}
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{policy.vehicle?.license_plate}</div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell>
                      ...
                      <div className="text-xs text-muted-foreground">{policy.payment_frequency}</div>
                    </TableCell>
                    <TableCell>
