...
import { Car, Calendar, DollarSign, Gauge, CheckCircle } from "lucide-react";
...
export function VehicleForm({
    ...
    const isFormValid = () => {
        ...
        console.log("Campos numéricos:", {
            ...
            annualMileage: `"${vehicleData.annualMileage}" - ${
                vehicleData.annualMileage.trim() !== "" &&
                !isNaN(Number(vehicleData.annualMileage)) &&
                Number(vehicleData.annualMileage) >= 0
            }`,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setCountdown(1); // Inicializar contador de 1 segundo
                        ...
                        {!isFormValid() && (
                            <Alert>
                                <AlertDescription>
                                    ...
                                    obligatorios que están marcados con
                                    asterisco (*).
                                </AlertDescription>
                            </Alert>
                        )}{" "}
